...
public class IngredientsAdapter extends RecyclerView.Adapter<IngredientsAdapter.GroceryViewHolder> {
    private Context mContext;
    private Cursor mCursor;

    public IngredientsAdapter(Context context, Cursor cursor) {
        mContext = context;
        mCursor = cursor;
    }
    ...
    public class GroceryViewHolder extends RecyclerView.ViewHolder {
        ...
        public GroceryViewHolder(View itemView) {
            ...
            nameText = itemView.findViewById(R.id.itemNameTextView);
            countText = itemView.findViewById(R.id.itemAmountTextView);
        }
    }
